...
const Login = () => {
  ...
  return (
    <div className="    flex flex-row  w-full  ">
      <div className="flex flex-col h-screen w-full justify-center items-center   md:gap-3  md:w-[50%] md:px-20 md:mt-[30px]  ">
        <div>
        ...
        {!correctPassword && send && !successful && (
        ...
        {successful && send && correctPassword && (
          <div className="flex w-full items-center  justify-center gap-2 bg-green-200 text-green-700 font-medium rounded-sm shadow-md text-center py-[20px] ">
      ...
      <div className=" w-[50%] fixed right-0 hidden md:block">
        <img
          src={img_page_signup}
          alt=""
